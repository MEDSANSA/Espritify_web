 ...
 */
final class Version20240325232049 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE evenement (id INT AUTO_INCREMENT NOT NULL, id_club INT DEFAULT NULL, titre VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, lieu VARCHAR(255) NOT NULL, date_debut DATE NOT NULL, date_fin DATE NOT NULL, INDEX IDX_B26681E33CE2470 (id_club), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE message (id INT AUTO_INCREMENT NOT NULL, id_user INT DEFAULT NULL, id_conv INT DEFAULT NULL, date TIMESTAMP DEFAULT CURRENT_TIMESTAMP, description VARCHAR(255) NOT NULL, INDEX IDX_B6BD307F6B3CA4B (id_user), INDEX IDX_B6BD307F826485CE (id_conv), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE participation_cours (id_cours INT NOT NULL, id_user INT NOT NULL, INDEX IDX_F2160117134FCDAC (id_cours), INDEX IDX_F21601176B3CA4B (id_user), PRIMARY KEY(id_cours, id_user)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE password_reset_token (id INT AUTO_INCREMENT NOT NULL, id_user INT DEFAULT NULL, timestamp TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, email VARCHAR(255) NOT NULL, INDEX IDX_6B7BA4B66B3CA4B (id_user), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE questions (id_question INT AUTO_INCREMENT NOT NULL, contenu VARCHAR(255) NOT NULL, rep1 VARCHAR(255) NOT NULL, rep2 VARCHAR(255) NOT NULL, rep3 VARCHAR(255) NOT NULL, bonne_reponse VARCHAR(255) NOT NULL, PRIMARY KEY(id_question)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE reclamation (id INT AUTO_INCREMENT NOT NULL, id_user INT DEFAULT NULL, titre VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, date TIMESTAMP DEFAULT CURRENT_TIMESTAMP, etat VARCHAR(255) NOT NULL, INDEX IDX_CE6064046B3CA4B (id_user), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE reponse_rec (id INT AUTO_INCREMENT NOT NULL, id_rec INT DEFAULT NULL, titre VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, date TIMESTAMP DEFAULT CURRENT_TIMESTAMP, INDEX IDX_CA85808FAA12276 (id_rec), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE participation_cours ADD CONSTRAINT FK_F21601176B3CA4B FOREIGN KEY (id_user) REFERENCES utilisateur (id)');
        ...
        $this->addSql('ALTER TABLE password_reset_token ADD CONSTRAINT FK_6B7BA4B66B3CA4B FOREIGN KEY (id_user) REFERENCES utilisateur (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE participation_cours DROP FOREIGN KEY FK_F21601176B3CA4B');
